...
window.events_created_chart = null
...
modulejs.define 'slzr/reports/events_created_by_day', ['jquery', 'underscore'], ($, _) ->
  ...
  drawChart: ->
    if window.events_created_chart != null
      window.events_created_chart.destroy()
    ctx = document.getElementById('canvas').getContext('2d')
    window.events_created_chart = new Chart(ctx).Line(chartData, responsive: true)
